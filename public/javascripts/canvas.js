...
function init() {
	...
	labels["logo"] = new Label({x: 0.5, y: 0.3}, "CARD TEST", 100, true, false, false, "Monoton");
	labels["play"] = new Label({x: 0.5, y: 0.7}, "PLAY!", 100, true, true, false, "Monoton", enterQueue);
	labels["searching"] = new Label({x: 0.5, y: 0.7}, "FINDING MATCH   ", 100, false, false, false, "Monoton");
	labels["result"] = new Label({x: 0.5, y: 0.3}, "", 120, false, false, false, "Monoton");
	labels["rematch"] = new Label({x: 0.5, y: 0.62}, "Rematch", 100, false, false, false, "Monoton", requestRematch);
	labels["waiting"] = new Label({x: 0.5, y: 0.62}, "Waiting   ", 100, false, false, false, "Monoton");
	labels["main menu"] = new Label({x: 0.5, y: 0.78}, "Main Menu", 100, false, false, false, "Monoton", exitMatch);
	labels["timer"] = new Label({x: 0.5, y: 0.1}, 20, 64, false, false, false, "Monoton");
}
...
function drawCard(card, position, scale) {
	...
	ctx.font = "bold " + (64 * scale * r) + "px Monoton";
...
function drawPointCard(card, position, scale) {
	...
	ctx.fillStyle = typeColors[card.type];
	ctx.font = "bold " + (72 * scale * r) + "px Monoton";
...
function drawUnknownCard(position, scale) {
	...
	ctx.font = "bold " + (72 * r * scale) + "px Monoton";
...
function drawLabel(label) {
	ctx.textBaseline = "middle";
	ctx.textAlign = "center";
	ctx.font = (label.size * r) + "px Monoton";
